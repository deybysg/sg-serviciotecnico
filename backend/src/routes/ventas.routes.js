...
import { obtenerVentas, obtenerVenta, crearVenta, obtenerVentasPorUsuario, generarComprobantePDF } from "../controllers/ventas.controllers.js";
import { authenticate, authorize } from "../middlewares/authMiddleware.js";
import { isPostgres } from "../config/dbProvider.js";
import * as pgCtrl from "../controllers_pg/ventas.controllers.js";

const ctrl = isPostgres() ? pgCtrl : { obtenerVentas, obtenerVenta, crearVenta, obtenerVentasPorUsuario, generarComprobantePDF };
