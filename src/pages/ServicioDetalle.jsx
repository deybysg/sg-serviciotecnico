...
const serviciosData = [
  {
    ...
    color: "cyan",
    descripcionLarga:
      "Ofrecemos un servicio completo de reparación de computadoras. Diagnosticamos y solucionamos todo tipo de fallas, desde problemas de hardware hasta virus y errores de software. Nuestro equipo técnico cuenta con años de experiencia y las herramientas necesarias para devolver tu PC al máximo rendimiento.",
    imagenes: [
    ...
    pasos: [
      "Traé tu PC a nuestro taller o solicitá retiro a domicilio",
      "Realizamos un diagnóstico completo y gratuito",
      "Te presupuestamos la reparación antes de proceder",
      "Ejecutamos la reparación con repuestos de calidad",
      "Probamos y verificamos que todo funcione perfecto",
      "Te devolvemos tu PC como nueva con garantía",
    ],
  },
  {
    id: 2,
  ...
  },
  {
    ...
    color: "pink",
    descripcionLarga:
      "Reemplazamos pantallas rotas o dañadas en celulares, tablets y notebooks. Trabajamos con repuestos de alta calidad y ofrecemos garantía en cada cambio. Recuperá la vista perfecta de tu dispositivo.",
    imagenes: [
    ...
    pasos: [
      ...
      "Reemplazamos la pantalla con precisión",
  ...
  },
  {
    ...
    color: "blue",
    descripcionLarga:
      "¿Tu batería no dura nada o se infló? Cambiamos la batería de tu celular o tablet con repuestos de primera calidad. Recuperá la autonomía original de tu dispositivo.",
    imagenes: [
  ...
  },
  {
    ...
    icono: <FaShieldAlt />,
    titulo: "GLASS DISEÑO",
    descripcionCorta: "Personalizá la parte trasera de tu celular con los mejores diseños en glass.",
    color: "purple",
    descripcionLarga:
      "Dale un toque único a tu celular con nuestros diseños exclusivos en glass. Protegé la parte trasera mientras expresás tu estilo. Tenemos una amplia variedad de diseños y colores.",
    imagenes: [
    ...
    pasos: [
      ...
      "Preparamos tu celular",
      "Aplicamos el glass con precisión",
      "Verificamos el resultado",
      "Disfrutá de tu celular personalizado",
    ],
  },
  {
    id: 8,
